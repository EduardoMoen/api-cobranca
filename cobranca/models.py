...
class Divida(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    # -------- Coluna 1 --------
    entidade = models.ForeignKey(Entidade, on_delete=models.PROTECT, related_name="boletos")
    responsavel = models.ForeignKey(Responsavel, on_delete=models.PROTECT, related_name="boletos")
    tipoCobranca = models.ForeignKey(TipoCobranca, on_delete=models.PROTECT, related_name="boletos")
    ...
    banco = models.ForeignKey(Banco, null=True, blank=True, on_delete=models.PROTECT, related_name="boletos")
    agencia = models.CharField(max_length=10, null=True, blank=True)
    conta = models.CharField(max_length=50, null=True, blank=True,)
    alinea = models.ForeignKey(Alinea, null=True, blank=True, on_delete=models.PROTECT, related_name="boletos")
    ...
    responsavelAtual = models.ForeignKey(Responsavel, null=True, blank=True, on_delete=models.PROTECT, related_name="atual_boletos")
    ...
    escola = models.ForeignKey(Escola, null=True, blank=True, on_delete=models.PROTECT, related_name="boletos")
    ...
    posicaoContrato = models.ForeignKey(PosicaoContrato, null=True, blank=True, on_delete=models.PROTECT, related_name="boletos")
    posicaoCheque = models.ForeignKey(PosicaoCheque, null=True, blank=True, on_delete=models.PROTECT, related_name="boletos")
    andamento = models.ForeignKey(Andamento, null=True, blank=True, on_delete=models.PROTECT, related_name="boletos")
    lugar = models.ForeignKey(Lugar, null=True, blank=True, on_delete=models.PROTECT, related_name="boletos")
    ...
    acordo = models.ForeignKey(Acordo, null=True, blank=True, on_delete=models.PROTECT, related_name="boletos")
