...
class Divida(models.Model):
    ...
    codigoCobranca = models.IntegerField(unique=True, db_index=True, null=True, blank=True)
    ...
    nomeAluno = models.CharField(max_length=100, null=True, blank=True)
    ...
    indiceInicial = models.DecimalField(max_digits=20, decimal_places=10, null=True, blank=True)
    mesFimCorrecao = models.IntegerField(null=True, blank=True)
    anoFimCorrecao = models.IntegerField(null=True, blank=True)
    indiceFinal = models.DecimalField(max_digits=20, decimal_places=10, null=True, blank=True)
    ...
    nomeResponsavelCobranca = models.CharField(max_length=100, null=True, blank=True)
